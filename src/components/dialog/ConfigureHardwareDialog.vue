<template>
  <q-dialog ref="dialog" persistent>
    <q-card class="bg-white text-black brand-round-l q-pa-lg" style="min-width: 1200px;height:80vh;">
        ...
        <q-tab-panels class="brand-round-l shadow-1" style="background-color: #F9F9F9;" v-model="panel">
          <q-tab-panel :name="0" class="q-pa-none">
            <div class="">
              <div class="row" style="height: 350px;">
                <div class="column flex q-pa-xl flex-center">
                  <div class="row">
                ...
                <div class="row q-mt-md">
                  <div class="col">
                    ...
                    <q-select class="brand-round-m" bg-color="white" outlined dense v-model="RS232[0]._baudRate"
                      :disable="!RS232[0]._isEnabled" :options="[1200, 2400, 4800, 9600, 19200, 38400, 57600, 115200]" />
                  </div>
                ...
                <div class="row q-mt-md">
                  <div class="col">
                    ...
                    <q-select class="brand-round-m" bg-color="white" outlined dense v-model="RS232[1]._baudRate"
                      :disable="!RS232[1]._isEnabled" :options="[1200, 2400, 4800, 9600, 19200, 38400, 57600, 115200]" />
                  </div>
                  <div style="width:20px" />
                  <div class="col">
                    <span class="q-pa-xs">Parity</span>
          ...
          <q-tab-panel :name="2" class="q-pa-none">
            <div class="row">
              ...
              <q-separator class="q-my-none q-ml-none" inset vertical
                style="background: linear-gradient(90deg, #EFEFEF 0%, rgba(255, 255, 255, 0) 80%);width: 25px;height: 380px;left: 358px;top: 0px;" />
              <div class="col q-pa-lg">
